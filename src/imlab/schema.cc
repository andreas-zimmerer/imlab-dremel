...
// ------------------------------------------------
uint64_t warehouseTable::insert(const Integer w_id, const Varchar<10> w_name, const Varchar<20> w_street_1, const Varchar<20> w_street_2, const Varchar<20> w_city, const Char<2> w_state, const Char<9> w_zip, const Numeric<4, 4> w_tax, const Numeric<12, 2> w_ytd) {
...
// ------------------------------------------------
uint64_t districtTable::insert(const Integer d_id, const Integer d_w_id, const Varchar<10> d_name, const Varchar<20> d_street_1, const Varchar<20> d_street_2, const Varchar<20> d_city, const Char<2> d_state, const Char<9> d_zip, const Numeric<4, 4> d_tax, const Numeric<12, 2> d_ytd, const Integer d_next_o_id) {
...
// ------------------------------------------------
uint64_t historyTable::insert(const Integer h_c_id, const Integer h_c_d_id, const Integer h_c_w_id, const Integer h_d_id, const Integer h_w_id, const Timestamp h_date, const Numeric<6, 2> h_amount, const Varchar<24> h_data) {
...
// ------------------------------------------------
uint64_t neworderTable::insert(const Integer no_o_id, const Integer no_d_id, const Integer no_w_id) {
...
// ------------------------------------------------
uint64_t orderTable::insert(const Integer o_id, const Integer o_d_id, const Integer o_w_id, const Integer o_c_id, const Timestamp o_entry_d, const Integer o_carrier_id, const Numeric<2, 0> o_ol_cnt, const Numeric<1, 0> o_all_local) {
...
// ------------------------------------------------
uint64_t orderlineTable::insert(const Integer ol_o_id, const Integer ol_d_id, const Integer ol_w_id, const Integer ol_number, const Integer ol_i_id, const Integer ol_supply_w_id, const Timestamp ol_delivery_d, const Numeric<2, 0> ol_quantity, const Numeric<6, 2> ol_amount, const Char<24> ol_dist_info) {
...
// ------------------------------------------------
uint64_t itemTable::insert(const Integer i_id, const Integer i_im_id, const Varchar<24> i_name, const Numeric<5, 2> i_price, const Varchar<50> i_data) {
