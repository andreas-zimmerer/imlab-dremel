...
#include "imlab/queryc/schema_parse_context.h"
#include "imlab/queryc/schema_compiler.h"
#include "imlab/queryc/default_schema.h

using QueryCompiler = imlab::queryc::QueryCompiler;
using QueryParseContext = imlab::queryc::QueryParseContext;
using defaultSchema = imlab::queryc::defaultSchema;
...
int main(int argc, char *argv[]) {
    ...
    QueryParseContext parse_context {defaultSchema};
